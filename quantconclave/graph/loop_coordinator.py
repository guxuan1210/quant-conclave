...
def run_full_loop(config: dict, trigger: str = "manual") -> dict:
    ...
    from quantconclave.graph.resolver import resolve_all_pending
    from quantconclave.graph.meta_evaluator import run_meta_evaluation
    from quantconclave.graph.experience_extractor import extract_experiences
