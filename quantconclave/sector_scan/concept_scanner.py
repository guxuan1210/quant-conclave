...
def scan_concept_stocks(concept_code: str, top_n: int = 10) -> dict:
    ...
    from quantconclave.sector_scan.smart_scanner import _score_one_stock, _filter_st_stocks
    from quantconclave.dataflows.eastmoney_sector import get_daily_basic_batch
