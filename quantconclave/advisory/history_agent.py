"""History Agent: LLM-powered analysis of historical QuantConclave analysis runs.
...
def build_history_agent_prompt(
    ...
    prompt = f"""You are the **QuantConclave History Agent** — an AI analyst specializing in reviewing historical stock analysis results and extracting actionable investment experiences.
...
You are reviewing past QuantConclave deep analysis results. Your goal is to:
