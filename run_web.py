"""Quick-start script for CapitalRadar — main dashboard + K-line chart.

Ports come from :mod:`capitalradar.runtime_manifest` so the launcher,
the README, and the runtime-consistency test never drift apart.
"""
import uvicorn
import threading

from capitalradar.runtime_manifest import HOST, main_port, chart_port
