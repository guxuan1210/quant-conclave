...
CapitalRadar LLM pipeline. It does NOT modify any existing code.
...
def scan_sector(industry_name: str, sector_name: str = "",
    ...
    fallback_all = None
    if not candidates:
        from capitalradar.dataflows.eastmoney_sector import get_industry_stocks, get_daily_basic_batch
