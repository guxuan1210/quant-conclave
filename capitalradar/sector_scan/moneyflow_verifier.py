...
def verify_moneyflow(
    ...
    if flow_rows:
        ...
        from capitalradar.dataflows.akshare_data import get_money_flow_akshare
        primary_rows = _fetch_source(get_money_flow_akshare, ticker)
        if primary_rows:
            primary_src = "东财逐日(akshare)"
        else:
            from capitalradar.dataflows.tushare_data import get_money_flow as get_tushare_money_flow
    ...
    from capitalradar.dataflows.tushare_data import get_money_flow_dc as get_ths_money_flow
