...
Usage::
    ...
    python -m capitalradar.prediction.trainer  # trains on all configured tickers
    python -m capitalradar.prediction.trainer --ticker 000001.SZ  # single ticker
    python -m capitalradar.prediction.trainer --list-only  # list available models
"""
...
from capitalradar.prediction.data_pipeline import build_train_samples
