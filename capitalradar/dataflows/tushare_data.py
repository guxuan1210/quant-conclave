...
def get_tushare_top_gainers(
    ...
    try:
        from capitalradar.sector_scan.top_gainers import get_top_gainers
...
def get_tushare_multi_factor_ranking(
    ...
    try:
        from capitalradar.sector_scan.top_gainers import get_multi_factor_ranking
...
def get_tushare_top_net_inflow(
    ...
    try:
        from capitalradar.sector_scan.top_gainers import get_top_net_inflow
