...
from capitalradar.agents.utils.core_stock_tools import (
    get_stock_data
)
from capitalradar.agents.utils.technical_indicators_tools import (
    get_indicators
)
...
def build_instrument_context(ticker: str, asset_type: str = "stock") -> str:
    ...
    skill_section = ""
    try:
        from capitalradar.graph.skill_generator import get_active_skill_path
        import os
