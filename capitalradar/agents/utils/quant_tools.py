"""QuantAgent-fused technical analysis tools for CapitalRadar.
...
Phase 4: Expanded factor library (CCI, ATR, trend_score, RSRS, ER, MA series,
         SuperTrend, volatility regime) — wrapping capitalradar.quant.indicators.
...
from capitalradar.quant import indicators as _indicators
from capitalradar.quant import utils as _quant_utils
