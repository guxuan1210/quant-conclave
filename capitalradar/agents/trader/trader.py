...
from capitalradar.agents.schemas import TraderProposal, render_trader_proposal
...
def create_trader(llm):
    ...
    def trader_node(state, name):
        ...
        human_line = (
            f"\n\n**Human Trader's Input** (additional context provided at checkpoint): {human_feedback}"
            if human_feedback
            else ""
        )
