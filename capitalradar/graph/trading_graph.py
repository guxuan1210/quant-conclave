# capitalradar/graph/trading_graph.py
...
from capitalradar.agents import *
from capitalradar.default_config import DEFAULT_CONFIG
from capitalradar.agents.utils.memory import CapitalRadarMemoryLog
from capitalradar.dataflows.utils import safe_ticker_component
from capitalradar.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from capitalradar.dataflows.config import set_config
...
from capitalradar.agents.utils.eastmoney_tools import (
...
class CapitalRadarGraph:
    ...
    def __init__(
        ...
        self.memory_log = CapitalRadarMemoryLog(self.config)
    ...
    def _load_last_state(self, ticker: str) -> dict | None:
        ...
        directory = Path(self.config["results_dir"]) / safe / "CapitalRadarStrategy_logs"
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "CapitalRadarStrategy_logs"
